def check_hyperparameters(param_grid, best_param):
    import warnings
    if min(param_grid) == best_param:
        warnings.warn('WARNING Hyperparameter minimum reached: ',best_param)
    elif max(param_grid) == best_param:
        warnings.warn('WARNING Hyperparameter maximum reached: ',best_param)
