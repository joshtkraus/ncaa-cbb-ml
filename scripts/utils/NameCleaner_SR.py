...
def clean_SR(df):
    ...
    Args:
        df: SportsReference DataFrame with a 'Team' column.
    ...
    df.loc[:, "Team"] = df["Team"].str.replace(
        "North Carolina At", "North Carolina A&T", regex=False
    )
    ...
    df.loc[:, "Team"] = df["Team"].str.replace(
        "North Carolina Wilmington", "UNC Wilmington", regex=False
    )
    df.loc[:, "Team"] = df["Team"].str.replace(
        "North Carolina Asheville", "UNC Asheville", regex=False
    )
    df.loc[:, "Team"] = df["Team"].str.replace("California Davis", "UC Davis", regex=False)
    df.loc[:, "Team"] = df["Team"].str.replace(
        "North Carolina Greensboro", "UNC Greensboro", regex=False
    )
    ...
    df.loc[:, "Team"] = df["Team"].str.replace(
        "California Santa Barbara", "UC Santa Barbara", regex=False
    )
    ...
    df.loc[:, "Team"] = df["Team"].str.replace(
        "Southern Illinois Edwardsville", "SIUE", regex=False
    )
